...
public class LoginManagerTest {
	...
	public void testValideerPass() {
		...
		Medewerker medewerker = new Medewerker(1, "Bob", "test", Status.ACTIEF);

		Mockito.when(MedewerkerDAO.getMedewerker(1)).thenReturn(medewerker);
	...
	public void testValideerInactive() {
		...
		Medewerker medewerker = new Medewerker(1, "Bob", "test", Status.INACTIEF);
	...
	public void testValideerInvalid() {
		...
		Mockito.when(MedewerkerDAO.getMedewerker(1)).thenReturn(null);
