...
public class pnlPraGeg extends JPanel {
	...
	public pnlPraGeg() {		
		praktijkManager = new PraktijkManager();		
	...
	private void genereerLayout() {
		...
		btnPraGegOpslaan.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (txtPraGegNaam.getText().equals("")
					&& txtPraGegNaam.getText().length() >= 30) {
					
					txtPraGegNaam.setBorder(redBorder);
					errorMessages.add("- Naam");
				}
				
				if (txtPraGegAdres.getText().equals("")
					&& txtPraGegAdres.getText().length() >= 50) {
					
					txtPraGegAdres.setBorder(redBorder);
					errorMessages.add("- Adres");
				}
				
				if (txtPraGegPostcode.getText().equals("")
					&& PanelValidatie.valideerPostcode(txtPraGegPostcode.getText())) {
					
					txtPraGegPostcode.setBorder(redBorder);
					errorMessages.add("- Postcode");
				}
				
				if (txtPraGegPlaats.getText().equals("") 
					&& txtPraGegPlaats.getText().length() >= 50) {
					
					txtPraGegPlaats.setBorder(redBorder);
					errorMessages.add("- Plaats");
				}
				
				if (txtPraGegIBAN.getText().equals("")
					&& txtPraGegIBAN.getText().length() >= 35) {
					
					txtPraGegIBAN.setBorder(redBorder);
					errorMessages.add("- IBAN");
				}
				
				if (txtPraGegTelnr.getText().equals("")
					&& txtPraGegTelnr.getText().length() >= 30) {
					
					txtPraGegTelnr.setBorder(redBorder);
					errorMessages.add("- Telefoonnummer");
				}
				
				if (txtPraGegEmail.getText().equals("") && txtPraGegEmail.getText().length() >= 50
					|| PanelValidatie.valideerEmail(txtPraGegEmail.getText())) {
					
					txtPraGegEmail.setBorder(redBorder);
					errorMessages.add("- Email");
				}
				
				if (txtPraGegWebsite.getText().equals("")
					&& txtPraGegWebsite.getText().length() >= 50) {
				...
				if (errorMessages.size() < 1) {
					Praktijk p = new Praktijk(
						praktijk.getId(), txtPraGegNaam.getText(), txtPraGegAdres.getText(), 
	...
	private void vulVelden() {
		txtPraGegNaam.setText(praktijk.getNaam());
		txtPraGegAdres.setText(praktijk.getAdres());
		txtPraGegPostcode.setText(praktijk.getPostcode());
		txtPraGegPlaats.setText(praktijk.getPlaats());
		txtPraGegIBAN.setText(praktijk.getIban());
		txtPraGegTelnr.setText(praktijk.getTelNr());
		txtPraGegEmail.setText(praktijk.getEmail());
		txtPraGegWebsite.setText(praktijk.getWebsite());
	}
